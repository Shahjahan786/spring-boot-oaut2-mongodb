...
public class MongoTokenStore implements TokenStore {
    ...
    public void storeAccessToken(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        mongoAccessToken.setToken(AccessToken.getAccessToken(accessToken));
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        ...
        MongoAccessToken mongoAccessToken = mongoTemplate.findOne(query, MongoAccessToken.class);
        return mongoAccessToken != null ? new AccessTokenImpl(mongoAccessToken.getToken()) : null;
    }
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        ...
        token.setToken(new RefreshToken(refreshToken.getValue()));
    ...
    public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
        ...
        if (mongoAccessToken != null) {
            AccessToken token = mongoAccessToken.getToken();
            
            accessToken = new AccessTokenImpl(token);
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String username) {
        ...
        for (MongoAccessToken accessToken : accessTokens) {
        	...
        	AccessToken token = accessToken.getToken();
        	
            tokens.add(new AccessTokenImpl(token));
        }
        return tokens;
    }
